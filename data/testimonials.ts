...
export const testimonials: Testimonial[] = [
  {
    id: "1",
    quote:
      "A unique ability to blend aesthetics with usability. Expertly blends aesthetics with usability, balancing form and function to create designs that are both beautiful and intuitive.",
    author: "Liam P",
    title: "UX Researcher",
